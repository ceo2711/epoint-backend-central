...
class PaymentLink(Base):
    ...
    payment_url: Mapped[str] = mapped_column(String(512))
    external_checkout_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
    external_checkout_url: Mapped[str | None] = mapped_column(String(512), nullable=True)
